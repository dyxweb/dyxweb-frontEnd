...
export default [
  ...
  { key: 'vue', label: 'vue' , submenu: [
    ...
    { key: '/web/vue/路由的权限角色控制', label: '路由的权限角色控制' },
    { key: '/web/vue/生命周期', label: '生命周期' },
    { key: '/web/vue/页面切换动画', label: '页面切换动画' },
    { key: '/web/vue/组件之间通信', label: '组件之间通信' },
    { key: '/web/vue/elementUI', label: 'elementUI' },
    { key: '/web/vue/vue-router', label: 'vue-router' },
    { key: '/web/vue/vue基础', label: 'vue基础' },
